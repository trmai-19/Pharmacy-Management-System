...
public class ReturnWarehouseController {
    ...
    public void initialize() {
        System.out.println("🔄 Đã nạp giao diện Quản Lý Đổi Trả (Kho).");
        ...
        if (cbSupplier != null) {
            cbSupplier.setItems(FXCollections.observableArrayList("Dược Hậu Giang", "Traphaco", "Hoa Linh", "GSK"));
        }
    ...
    private void loadMockData() {
        // Chỉ nạp dữ liệu trả hàng Nhà Cung Cấp, không có dữ liệu Khách Hàng
    ...
    @FXML void onBtnShowReturnNCC(ActionEvent event) { 
        if (modalReturnNCC != null) modalReturnNCC.setVisible(true); 
    }
